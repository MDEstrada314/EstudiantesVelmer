...
if (isset($_POST['editar'])) {
    ...
    $data->setSkils($_POST['skils']);


    
    $data->update();
     echo "<script>alert('datos Actulizados sactifactoriamente');document.location='estudiantes.php'</script>"; 
};
    ...
    <div class="parte-media">
      ...
      <form class="col d-flex flex-wrap" action=""  method="post">
              ...
              <div class="m-2 col-3">
                ...
                <input type="number" class="form-control" id="ingles" 
                name="ingles" step="0.1" max="5.0" min="1.0"
                value = "<?php echo $value['ingles'];?>"
                >
              </div>
              <div class="m-2 col-3">
                <label for="ser" class="form-label">Ser</label>
                <input type="number" class="form-control" id="ser" 
                name="ser" step="0.1" max="5.0" min="1.0"
                value = "<?php echo $value['ser'];?>"
                >
              </div>   <div class="m-2 col-3">
                <label for="review" class="form-label">Review</label>
                <input type="number" class="form-control" id="review" 
                name="review" step="0.1" max="5.0" min="1.0"
                value = "<?php echo $value['review'];?>"
                >
              </div>   <div class="m-2 col-3">
                <label for="skils" class="form-label">Skils</label>
                <input type="number" class="form-control" id="skils" 
                name="skils" step="0.1" max="5.0" min="1.0"
                value = "<?php echo $value['skils'];?>"
                >
              </div>
