...
+
            ...
            <tr>
              ...
              <td><?php echo $value['skils']?>  </td>
              <td><?php echo $value['especialidad']?>  </td>
              <td>
                <a class="btn btn-danger" href="boorarEstudiantes.php?id=<?=$value['id']?>&req=delete"> BORRAR</a>
                <a class="btn btn-warning" href="actualizarEstudiantes.php?id=<?=$value['id']?>"> Editar</a>
              </td>
            </tr>
            <?php } ?>
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="registrarEstudiantes.php" method="post">
              ...
              <div class="m-2 col-3">
                ...
                <input type="number" class="form-control" id="ingles" name="ingles" step="0.1" max="5.0" min="1.0">
              </div>
              <div class="m-2 col-3">
                <label for="ser" class="form-label">ser</label>
                <input type="number" class="form-control" id="ser" name="ser" step="0.1" max="5.0" min="1.0">
              </div>
              <div class="m-2 col-3">
                <label for="review" class="form-label">Review</label>
                <input type="number" class="form-control" id="review" name="review" step="0.1" max="5.0" min="1.0">
              </div>
              <div class="m-2 col-3">
                <label for="skils" class="form-label">Skils</label>
                <input type="number" class="form-control" id="skils" name="skils" step="0.1" max="5.0" min="1.0">
              </div>
              <div class="m-2 col-5">
